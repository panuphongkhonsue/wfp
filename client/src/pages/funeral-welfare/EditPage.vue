          ...
          <q-card flat bordered class="full-height">
            ...
            <q-card-section class="row wrap q-col-gutter-y-md q-px-md q-py-none font-medium font-16 text-grey-9">
              <template v-if="isView">
                <p class="col-lg-4 col-12 q-mb-none">
                  เลขที่ใบเบิก : <span class="font-medium font-16 text-grey-7">670001</span>
                </p>
                <p class="col-lg-4 col-12 q-mb-none">
                  วันที่ร้องขอ : <span class="font-medium font-16 text-grey-7">-</span>
                </p>
                <p class="col-lg-4 col-12 q-mb-none">
                  สถานะ : <span class="font-medium font-16 text-grey-7">รอตรวจสอบ</span>
                </p>
              </template>
              ...
              <div class="col-lg-4 col-12 q-mb-none">
                ...
                <div class="col-lg-4 col-12 q-mb-none q-pt-md">
                  <InputGroup for-id="fund" is-dense v-model="model.fund1" :data="model.fund ?? '-'"
              ...
              <q-card-section class="col row justify-around  q-pt-none">
                ...
                <div class="col-lg-2 col-12 q-mb-none q-pt-md text-black">
